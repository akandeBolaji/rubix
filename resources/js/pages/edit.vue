            ...
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form>
                  ...
                  <v-text-field v-if="userData.profile && userData.profile.headline" prepend-icon="work"  v-model="profile.headline" name="headline" :placeholder="userData.profile.headline" label="Career Summary" type="text"></v-text-field>
