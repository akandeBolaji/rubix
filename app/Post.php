...
class Post extends Model
{
    ...
    return $this->belongsToMany( 'App\User', 'users_posts_shares', 'post_id', 'user_id');
    }
    ...
    public function friendshares(){
        return $this->belongsToMany( 'App\User', 'users_posts_shares', 'post_id', 'user_id')->whereIn('user_id', JWTAuth::parseToken()->authenticate()->getFriends()->pluck('id'));
    }
    ...
    // $user = JWTAuth::parseToken()->authenticate();
        return $this->belongsToMany( 'App\User', 'users_posts_shares', 'post_id', 'user_id')->where('user_id', JWTAuth::parseToken()->authenticate()->id);
    }

    public function usercomment(){
        // $user = JWTAuth::parseToken()->authenticate();
            return $this->belongsToMany( 'App\User', 'users_posts_comments', 'post_id', 'user_id')->where('user_id', JWTAuth::parseToken()->authenticate()->id);
        }
