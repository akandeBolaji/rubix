...
class LikeEvent implements ShouldBroadcast
{
    ...
    {
        return ['auth' => $this->user, 'user' => $this->data->User, 'post' => $this->data, 'friendlikes' => $this->data->Friendlikes, 'userlike' => $this->data->Userlike, 'images' => $this->data->Images, 'likes' => $this->data->Likes, 'comments' => $this->data->Comments, 'videos' => $this->data->Videos];
    }
